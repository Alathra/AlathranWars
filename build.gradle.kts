...
plugins {
    ...
    id("io.papermc.paperweight.userdev") version "1.5.11" // Used to develop internal plugins using Mojang mappings, See https://github.com/PaperMC/paperweight
...
dependencies {
    ...
    compileOnly("com.palmergames.bukkit.towny:towny:0.100.1.17") {
