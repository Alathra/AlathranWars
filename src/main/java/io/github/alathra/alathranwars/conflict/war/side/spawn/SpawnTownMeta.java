...
public class SpawnTownMeta {
    private static final BooleanDataField IS_PROXIED = new BooleanDataField("alathranwars_spawnpoint_is_proxied", false);
    private static final InstantDataField LAST_PROXIED = new InstantDataField("alathranwars_spawnpoint_last_proxied");
    private static final InstantDataField START_PROXIED = new InstantDataField("alathranwars_spawnpoint_start_proxied");
