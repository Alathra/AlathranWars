...
//        return raids.stream().anyMatch(raid -> raid.getTown().equals(town));
    ...
    /**
     * End a war for the specified reason. Triggered internally by {@link War#defeat(Side)} {@literal &} {@link War#draw()}.
     *
    ...
    public static class Builder {
        ...
        public Builder setSide1(Side side1) {
            this.side1 = side1;
            return this;
        }

        public Builder setSide2(Side side2) {
            this.side2 = side2;
            return this;
        }
        ...
        private boolean canStartWar() {
            ...
            if (AlathranWarsAPI.getInstance().hasAttackCooldown(aggressor))
                return false;

            return !AlathranWarsAPI.getInstance().hasDefenseCooldown(victim);
        }
    }
}