package io.github.alathra.alathranwars.mercenary;
...
public class MercenaryMeta {
    ...
    private static final BooleanDataField IS_MERCENARY = new BooleanDataField("alathranwars_isMercenary", false);
