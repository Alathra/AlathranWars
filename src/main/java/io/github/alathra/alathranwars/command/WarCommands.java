...
public class WarCommands {
    ...
    protected static void warCreate(CommandSender p, @NotNull CommandArguments args) throws WrapperCommandSyntaxException {
        ...
        War.Builder builder = War.builder()
        ...
        try {
            ...
            throw CommandAPIBukkit.failWithAdventureComponent(ColorParser.of("<red>" + e.getMessage()).build());
        }
    }
    ...
    protected static void warJoin(Player p, @NotNull CommandArguments args, boolean asAdmin) throws WrapperCommandSyntaxException {
        ...
        switch (targetType) {
            case NATION -> {
                ...
                if (!war.isEventWar()) {
                    if (side.isAttacker() && AlathranWarsAPI.getInstance().hasAttackCooldown(nation)) {
                        throw CommandAPIBukkit.failWithAdventureComponent(ColorParser.of("<red>Nation has attacking cooldown and cannot join the war.").build());
                    } else if (side.isDefender() && AlathranWarsAPI.getInstance().hasDefenseCooldown(nation)) {
                        throw CommandAPIBukkit.failWithAdventureComponent(ColorParser.of("<red>Nation has defensive cooldown and cannot join the war.").build());
                    }
                }
            ...
            case TOWN -> {
                ...
                if (!war.isEventWar()) {
                    if (side.isAttacker() && AlathranWarsAPI.getInstance().hasAttackCooldown(town)) {
                        throw CommandAPIBukkit.failWithAdventureComponent(ColorParser.of("<red>Town has attacking cooldown and cannot join the war.").build());
                    } else if (side.isDefender() && AlathranWarsAPI.getInstance().hasDefenseCooldown(town)) {
                        throw CommandAPIBukkit.failWithAdventureComponent(ColorParser.of("<red>Town has defensive cooldown and cannot join the war.").build());
                    }
                }
            ...
            case PLAYER -> {
                ...
                if (!war.isEventWar()) {
                    if (side.isAttacker() && AlathranWarsAPI.getInstance().hasAttackCooldown(player)) {
                        throw CommandAPIBukkit.failWithAdventureComponent(ColorParser.of("<red>Player has attacking cooldown and cannot join the war.").build());
                    } else if (side.isDefender() && AlathranWarsAPI.getInstance().hasDefenseCooldown(player)) {
                        throw CommandAPIBukkit.failWithAdventureComponent(ColorParser.of("<red>Player has defensive cooldown and cannot join the war.").build());
                    }
                }
